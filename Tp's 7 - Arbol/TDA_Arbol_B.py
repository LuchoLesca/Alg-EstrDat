...
# Rama(arista) = camino entre un nodo y el siguiente. Hay un solo camino de ramas para llegar de un nodo a otro
# Nivel de un nodo = Se termina entre la cantidad de ramas que hay entre un nodo y la raíz. Esto más 1
# Altura de un nodo = es la mayor cantidad de ramas entre ese nodo y la hoja más lejana
